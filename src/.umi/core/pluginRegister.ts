...
import * as Plugin_2 from '/Users/dumildematos/Documents/Projectos/simpledoc-backoffice/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_6 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: '/Users/dumildematos/Documents/Projectos/simpledoc-backoffice/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
